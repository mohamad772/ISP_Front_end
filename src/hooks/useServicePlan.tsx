import { getAllServicePlans, getServicePlanById, createServicePlan, updateServicePlan, activateServicePlan, deactivateServicePlan } from "@/service/seviceplane.service";
import { ServicePlan } from "@/types/api.types";
import { ServicePlanFilters, CreateServicePlanRequest, UpdateServicePlanRequest } from "@/types/api.types";
import {
  useQuery,
  useMutation,
  useQueryClient,
